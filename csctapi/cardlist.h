...
hdplus03 =	{ "HD-Plus 03", 0, 12, "3F FF 95 00 FF 91 81 71 A0 47 00 44 4E 41 53 50 31 38 30 20 4D 65 72 30 30 30 28",    80, 0, "\xA7\x64\x2F\x57\xBC\x96\xD3\x7C\x00", "", "\x00" };
eliteryl =  { "Mega Elite Royal", 0, 0, "3F 77 18 00 00 C2 EB 41 02 6C 90 00",                                           35, 0, "\x01\x4D\x90\x2F\x00", "\x00", "\x22\xD6\x0F\x37\x56\x7B\xAB\x12\xF5\x05\xD8\xC8\xC7\x1A\x22\xE3\x00" };
...
void findatr(struct s_reader *reader)
{
	...
	if ( strncmp(current.atr, hdplus01.atr, hdplus01.atrsize) == 0 ) {
		...
		current.found = 1;
	} else if ( strncmp(current.atr, eliteryl.atr, eliteryl.atrsize) == 0 ) {
